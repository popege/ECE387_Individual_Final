...
/********************************************************
 USER DEFINITIONS
********************************************************/
#define TXPIN 3   //software UART Transmit pin - Connect this pin to SmartWAV RX pin //changed from 3
#define RXPIN 2  //software UART Receive pin - Connect this pin to SmartWAV TX pin //changed from 2
